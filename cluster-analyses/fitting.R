...
#### Lines 11-82 rely on a large file not stored in this repo, available upon request. 
#### Their purpose is to generate a smaller file, maf.RData, which is stored in this repo.
#### This script can be run from line 83 onwards and produce the same results.
...
# 
# p3 <- ggplot() +
#   geom_point(aes(x = (approx_qtile(breaks)), y = (quantile(maf, breaks))), color = "#CCCCCC", size = 5) +
#   geom_function(fun = function(x){x}, color = "#2255BB", linewidth = 1.5, linetype = "dashed") +
...
# print(p3)
# 
# ggsave("./figs/qq.pdf", width = 6, height = 6)
# ggsave("./figs/qq.png", width = 6, height = 6)
# 
